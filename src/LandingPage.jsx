...
function Home() {
    return (
        <>
                ...
                <div className="container">
                    <div className="hero-content-wrapper">
                        <div className="hero-text">
                            ...
                            <h1>You know what's happening. Find out why.</h1>
                            <p className="subhead">Systematic measurement for GTM Strategy gaps. See which portfolio companies need help and what to fix first.</p>
            ...
            <section className="alt-bg">
                <div className="container-narrow">
                    <h2>See What to Fix</h2>
                    <p className="subhead-section">When a portfolio company needs intervention, our detailed diagnostic isolates exactly what's broken and ranks fixes by revenue impact. You get the root cause, prioritized roadmap, and projected improvement—not just a score.</p>
                    
                    <div className="content-image">
                        <img src="/fleetops-diagnostic.png" alt="FleetOps diagnostic showing dimension scores, critical findings, priority ranking, and projected improvement" />
                    </div>
                </div>
            </section>
